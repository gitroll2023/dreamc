...
export const metadata: Metadata = {
  title: "드림캐쳐 - 청년 문화 체험 플랫폼 체험단 | 여수, 목포, 화순, 나주",
  description: "여수, 목포, 화순, 나주 - 전라남도 청년들을 위한 할인 체험 프로그램. 칵테일, 베이킹, 보드게임, 캘리그래피 등 다양한 문화 체험을 특별 할인가로 만나보세요.",
  ...
  openGraph: {
    ...
    images: [
      {
        url: "http://dreamcatcher.sslab.cloud/og-image.png",
        width: 1200,
        height: 630,
  ...
  twitter: {
    ...
    title: "드림캐쳐 - 청년 문화 체험 플랫폼 체험단 | 여수, 목포, 화순, 나주",
    description: "여수, 목포, 화순, 나주 - 전라남도 청년들을 위한 할인 체험 프로그램",
    images: ["http://dreamcatcher.sslab.cloud/og-image.png"],
  },
  robots: {
    index: true,
    follow: true,
