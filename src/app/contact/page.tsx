...
export default function ContactPage() {
  ...
  const programFAQs = [
    ...
    },
    {
      ...
      answer: '현재는 2026년 3월 정식 런칭 전 체험 기간입니다. 여러 장학회의 후원으로 운영되고 있어 재료비 및 최소 운영비만 받고 있습니다. 여러분의 피드백을 통해 더 나은 프로그램을 만들어가고 있습니다.'
    },
    {
    ...
    },
    {
      ...
      answer: '드림캐쳐는 각 지역에 고정된 본부 사무실을 두지 않고, 후원사의 지원을 통해 공유오피스를 대여하거나 건물주와의 협의를 통해 목적에 맞는 공간을 활용합니다. 현재 여수, 목포, 화순, 나주의 청년센터와 문화공간에서 프로그램을 진행하고 있으며, 온라인 회의를 통해 기획하고 각 지역에서 시범 운영 중입니다.'
    },
    {
  ...
  const operationFAQs = [
    ...
    {
      question: '주차는 가능한가요?',
      answer: '각 지역 청년센터와 문화공간에 주차장이 마련되어 있습니다. 다만 공간이 한정적이므로 대중교통 이용을 권장합니다.'
    },
    {
    ...
    },
    {
      ...
      answer: '2026년 3월 정식 론칭 예정입니다. 그 전까지는 체험 기간으로 운영되며, 여러분의 피드백을 반영하여 더 나은 서비스를 준비하고 있습니다.'
    }
  ];
